...
export const replay: Translation<typeof source> = {
  ...
  'replay.updatesPerSecond': { one: '{count} update per second', few: '{count} updates per second', many: '{count} updates per second', other: '{count} updates per second' },
  'replay.oneUpdatePerSeconds': { one: '1 update per {count} second', few: '1 update per {count} seconds', many: '1 update per {count} seconds', other: '1 update per {count} seconds' },
