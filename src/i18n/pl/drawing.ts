...
export const drawing: Translation<typeof source> = {
  ...
  'drawing.countDrawings': { one: '{count} drawing', few: '{count} drawings', many: '{count} drawings', other: '{count} drawings' },
  'drawing.countIndicators': { one: '{count} indicator', few: '{count} indicators', many: '{count} indicators', other: '{count} indicators' },
