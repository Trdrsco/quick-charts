...
export const menu: Translation<typeof source> = {
  ...
  'menu.removeIndicators': { one: 'Remove {count} indicator', few: 'Remove {count} indicators', many: 'Remove {count} indicators', other: 'Remove {count} indicators' },
  'menu.removeDrawings': { one: 'Remove {count} drawing', few: 'Remove {count} drawings', many: 'Remove {count} drawings', other: 'Remove {count} drawings' },
