...
export const account: Translation<typeof source> = {
  ...
  'account.reversed': { zero: 'Reversed {instrument} ({count} orders cancelled)', one: 'Reversed {instrument} ({count} order cancelled)', two: 'Reversed {instrument} ({count} orders cancelled)', few: 'Reversed {instrument} ({count} orders cancelled)', many: 'Reversed {instrument} ({count} orders cancelled)', other: 'Reversed {instrument} ({count} orders cancelled)' },
