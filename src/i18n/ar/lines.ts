...
export const lines: Translation<typeof source> = {
  ...
  'lines.ticks': { zero: '{sign} {value} ticks', one: '{sign} {value} tick', two: '{sign} {value} ticks', few: '{sign} {value} ticks', many: '{sign} {value} ticks', other: '{sign} {value} ticks' },
  ...
  'lines.positionReversedOrders': { zero: 'Position reversed · {count} orders cancelled', one: 'Position reversed · {count} order cancelled', two: 'Position reversed · {count} orders cancelled', few: 'Position reversed · {count} orders cancelled', many: 'Position reversed · {count} orders cancelled', other: 'Position reversed · {count} orders cancelled' },
