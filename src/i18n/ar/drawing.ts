...
export const drawing: Translation<typeof source> = {
  ...
  'drawing.countDrawings': { zero: '{count} drawings', one: '{count} drawing', two: '{count} drawings', few: '{count} drawings', many: '{count} drawings', other: '{count} drawings' },
  'drawing.countIndicators': { zero: '{count} indicators', one: '{count} indicator', two: '{count} indicators', few: '{count} indicators', many: '{count} indicators', other: '{count} indicators' },
