...
export const lines: Translation<typeof source> = {
  ...
  'lines.ticks': { one: '{sign} {value} tick', two: '{sign} {value} ticks', other: '{sign} {value} ticks' },
  ...
  'lines.positionReversedOrders': { one: 'Position reversed · {count} order cancelled', two: 'Position reversed · {count} orders cancelled', other: 'Position reversed · {count} orders cancelled' },
