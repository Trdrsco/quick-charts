...
export const account: Translation<typeof source> = {
  ...
  'account.reversed': { one: 'Reversed {instrument} ({count} order cancelled)', two: 'Reversed {instrument} ({count} orders cancelled)', other: 'Reversed {instrument} ({count} orders cancelled)' },
