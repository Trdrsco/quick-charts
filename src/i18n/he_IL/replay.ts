...
export const replay: Translation<typeof source> = {
  ...
  'replay.updatesPerSecond': { one: '{count} update per second', two: '{count} updates per second', other: '{count} updates per second' },
  'replay.oneUpdatePerSeconds': { one: '1 update per {count} second', two: '1 update per {count} seconds', other: '1 update per {count} seconds' },
