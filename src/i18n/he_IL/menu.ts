...
export const menu: Translation<typeof source> = {
  ...
  'menu.removeIndicators': { one: 'Remove {count} indicator', two: 'Remove {count} indicators', other: 'Remove {count} indicators' },
  'menu.removeDrawings': { one: 'Remove {count} drawing', two: 'Remove {count} drawings', other: 'Remove {count} drawings' },
