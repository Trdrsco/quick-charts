...
export const menu: Translation<typeof source> = {
  ...
  'menu.removeIndicators': { one: 'Remove {count} indicator', many: 'Remove {count} indicators', other: 'Remove {count} indicators' },
  'menu.removeDrawings': { one: 'Remove {count} drawing', many: 'Remove {count} drawings', other: 'Remove {count} drawings' },
