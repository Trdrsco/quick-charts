...
export const lines: Translation<typeof source> = {
  ...
  'lines.positionReversedOrders': { one: 'Position reversed · {count} order cancelled', many: 'Position reversed · {count} orders cancelled', other: 'Position reversed · {count} orders cancelled' },
