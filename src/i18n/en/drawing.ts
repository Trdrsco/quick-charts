// The drawing WORKFLOW's vocabulary: the toolbar's groups and section headings, its cursor,
// magnet, lock, hide, sync, remove and favorites controls, the selected drawing's settings bar
...
export const drawing = {
  ...
  // flyouts. `shapes` and `textNotes` each name both a group and a section: one word, one key.
  ...
  // The toolbar's actions and switches.
  ...
  // Favorites: the toolbar's stars and the floating bar they fill.
  ...
  // The selected drawing's floating settings bar.
  ...
  // Property labels shared by the bar and the dialog.
  'drawing.color': 'Color',
  ...
  // Style and Inputs rows, per tool family.
  ...
  // Fibonacci and Gann level rows. A level's own value is data and rides in the slot.
  ...
  // The glyph picker. Category HEADINGS are interface; every glyph in them is data.
