...
export const en = { ...legend, ...tools, ...rail, ...ticket, ...account, ...menu, ...lines, ...replay, ...inputs, ...broker, ...session, ...layouts, ...marks, ...host } as const
...
export const catalogs: readonly Readonly<Record<string, string | object>>[] = [legend, tools, rail, ticket, account, menu, lines, replay, inputs, broker, session, layouts, marks, host]
