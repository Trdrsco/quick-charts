...
export const en = { ...legend, ...tools, ...rail, ...menu, ...replay, ...inputs, ...session, ...layouts, ...host, ...indicators, ...timeframe, ...timezone, ...range, ...status, ...search, ...drawing, ...command } as const
...
export const catalogs: readonly Readonly<Record<string, string | object>>[] = [legend, tools, rail, menu, replay, inputs, session, layouts, host, indicators, timeframe, timezone, range, status, search, drawing, command]
