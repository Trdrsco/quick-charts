...
export const drawing: Translation<typeof source> = {
  ...
  'drawing.countDrawings': { one: '{count} drawing', many: '{count} drawings', other: '{count} drawings' },
  'drawing.countIndicators': { one: '{count} indicator', many: '{count} indicators', other: '{count} indicators' },
