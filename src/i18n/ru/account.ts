...
export const account: Translation<typeof source> = {
  ...
  'account.reversed': { one: 'Reversed {instrument} ({count} order cancelled)', few: 'Reversed {instrument} ({count} orders cancelled)', many: 'Reversed {instrument} ({count} orders cancelled)', other: 'Reversed {instrument} ({count} orders cancelled)' },
