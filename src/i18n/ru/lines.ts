...
export const lines: Translation<typeof source> = {
  ...
  'lines.ticks': { one: '{sign} {value} tick', few: '{sign} {value} ticks', many: '{sign} {value} ticks', other: '{sign} {value} ticks' },
  ...
  'lines.positionReversedOrders': { one: 'Position reversed · {count} order cancelled', few: 'Position reversed · {count} orders cancelled', many: 'Position reversed · {count} orders cancelled', other: 'Position reversed · {count} orders cancelled' },
