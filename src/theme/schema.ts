 ...
 *  `over`, reaches `min` under the WCAG 2.2 contrast formula. Body text needs 4.5, a non-text
 *  indicator such as a focus ring needs 3. */
...
export interface ThemeRole {
  ...
  description: string
  /** Present when the role carries a readability requirement. */
  contrast?: ThemeContrastRule
}
...
export const THEME_ROLES = [
  ...
  { id: 'text.primary', family: 'text', kind: 'color', description: 'Default ink for chart controls, menus, and dialogs.', contrast: { over: 'chrome.surface', min: 4.5 } },
  { id: 'text.secondary', family: 'text', kind: 'color', description: 'Supporting ink: descriptions, group headings, secondary values.', contrast: { over: 'chrome.surface', min: 4.5 } },
  { id: 'text.muted', family: 'text', kind: 'color', description: 'The least emphasized readable ink, such as a keyboard hint.', contrast: { over: 'chrome.surface', min: 4.5 } },
  ...
  { id: 'text.inverse', family: 'text', kind: 'color', description: 'Ink on a saturated accent fill.', contrast: { over: 'state.accent', min: 4.5 } },
  ...
  { id: 'state.accent', family: 'state', kind: 'color', description: 'The accent an active tool or a primary action wears.' },
